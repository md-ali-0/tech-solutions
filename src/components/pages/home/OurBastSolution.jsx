                ...
                <div className="px-6">
                    <div className="w-fit mx-auto">
                        <div className="flex justify-center gap-3">
                            ...
                            <h3 className="font-medium text-xs md:text-base">Our Best Solution</h3>
                        </div>
                    ...
                    <div className="flex flex-col md:flex-row justify-between gap-8">
                        <div className="bg-[#0F263E] rounded-3xl lg:w-[70%] p-10">
                            <div className="flex flex-col md:flex-row justify-between items-center">
                                <div className="">
                                    <h4 className="text-[#F5F9FD] text-[32px] font-semibold pb-5">
                                        Al Driven Solutions
                                    </h4>
                                    <p className="pb-20">
                        ...
                        <div className="bg-[#0F263E] rounded-3xl lg:w-[30%] p-10">
                            <div className="">
                                <div className="">
                                    <h4 className="text-[#F5F9FD] text-[32px] font-semibold pb-5">
                                        Digital Marketing
